...
# GET endpoint for /forecast (after app is instantiated)
@app.get("/forecast")
def predict_stock_get(
    ticker: str = Query(..., description="Stock ticker symbol"),
    forecast_date: str = Query(..., description="Forecast date in MM/DD/YYYY format")
):
    """
    Predict stock price for the given ticker and forecast date (MM/DD/YYYY) via GET request.
    """
